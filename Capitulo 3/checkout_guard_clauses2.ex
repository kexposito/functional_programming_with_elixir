defmodule CheckoutWithGuardClausesTwo do
...
IO.puts("CheckoutWithGuardClausesTwo.tax_cost(40, 0.1)")
IO.inspect(CheckoutWithGuardClausesTwo.tax_cost(40,0.1))

IO.puts("CheckoutWithGuardClausesTwo.total_cost(40, 0.1)")
IO.inspect(CheckoutWithGuardClausesTwo.total_cost(40,0.1))
